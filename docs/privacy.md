...
- The Edge extension uses the browser's local extension storage only to copy a legacy unpacked Chrome workspace when it is available; it does not upload that data.
